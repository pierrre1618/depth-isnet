...
def main(device,train_datasets,
         valid_datasets,
...
if __name__ == "__main__":
    ...
    if hypar["mode"] == "train":
        ...
        hypar["model_path"] ="/content/drive/MyDrive/data_train/results" ## model weights saving (or restoring) path
    ...
    hypar["model"] = ISNetDIS(in_ch=3) #U2NETFASTFEATURESUP()
